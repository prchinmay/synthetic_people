...
if __name__ == '__main__':
    ...
    for path in list_test: 
        ...
        if line.split(' ')[-1]:
            ...
            bbox = [['0,0,0,0,0']]
        temp = {'IMG': line.split(' ')[0].split('/')[-1].strip()[:-4], 'bbox_test': bbox}
    ...
    for path in list_true:
        ...
        if line.split(' ')[-1][-1]:
            ...
            bbox = ['0,0,0,0,0']
        temp = {'IMG': line.split(' ')[0].split('/')[-1].strip()[:-4], 'bbox_true': bbox}
    ...
    df_output['FP'] = df_output['IoU'].apply(lambda x: int(0.05<x < overlap_threshold))
    ...
    print(df_output['Precision'], df_output['Recall'], df_output['r_interp'], df_output['F1'])
    ...
    #df_metrics = df_output.loc[df_metrics['F1'].idxmax(), ['Recall', 'Precision', 'F1']]
